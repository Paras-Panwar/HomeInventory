...
import java.text.*;
import java.awt.print.*;
public class HomeInventory<JDateChooserr> extends JFrame
{
    // Toolbar
    JToolBar inventoryToolBar = new JToolBar();
    JButton newButton = new JButton(new ImageIcon("new.gif"));
    ...
    JTextField priceTextField = new JTextField();
    JLabel dateLabel = new JLabel();
    JapaneseDate dateDateChooser = new JDateChooser();
    JLabel storeLabel = new JLabel();
    JTextField storeTextField = new JTextField();
    JLabel noteLabel = new JLabel();
    JTextField noteTextField = new JTextField();
...
// frame constructor
        ...
        gridConstraints.insets = new Insets(10, 10, 0, 0);
        gridConstraints.anchor = GridBagConstraints.WEST;
        getContentPane().add(dateLabel, gridConstraints);dateDateChooser.setPreferredSize(new Dimension(120, 25));
        gridConstraints = new GridBagConstraints();
        gridConstraints.gridx = 5;
        gridConstraints.gridy = 3;
        gridConstraints.gridwidth = 2;
...
// dividing line
            ...
            g2D.drawString("Price: $" + HomeInventory.myInventory[i].purchasePrice + "," + " Purchased on: " +
                    HomeInventory.myInventory[i].purchaseDate, (int) (pf.getImageableX() + y+= dy));
